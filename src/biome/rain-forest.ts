...
export class RainForest implements Biome {
    ...
    public description: string = 'These trees are really big. The sun is hiding behind their leafs. Humidity is way too high for my integrated circuits. No, I’m not a complaining robot. Just being realistic here...';
